...
- Added new filetype `DAV12-RAW-FF3-TBL3-202508140001-TOA5-DAT-1MIN`
- Added new filetype `DAV12-RAW-FF4-TBL4-202507161445-TOA5-DAT-1MIN`
...
- Added new filetype `LAE13-RAW-NABEL-200501010000-SSV-TXT-10MIN`
- Added new filetype `LAE13-RAW-NABEL-201601010000-SSV-TXT-10MIN`
- Added new filetype `LAE13-RAW-NABEL-201801010000-SSV-TXT-10MIN`

## v20250517 | 17 May 2025

- Added new filetype `PROC-ETH-METEOSCREENINGTOOL-CH-LAE-CSV-30MIN`
- Added new filetype `PROC-ETH-METEOSCREENINGTOOL-CH-LAE-FF-A-200401010000-CSV-30MIN`
- Added new filetype `PROC-ETH-METEOSCREENINGTOOL-CH-LAE-FF-B-201901010000-CSV-30MIN`
- Added new filetype `PROC-ETH-METEOSCREENINGTOOL-CH-FRU-CSV-30MIN`
- Updated variables in `FOR10-RAW-202403141026-TOA5-DAT-1MIN`
- Fixed LW units in `LAE10-RAW-TBL1-201701230926-TOA5-DAT-1MIN`

## v20250318 | 18 Mar 2025

- Added new filetype `PROC-ETH-METEOSCREENINGTOOL-FF-CH-LAE-CSV-30MIN`
- Added new filetype `PROC-ETH-NABEL-CH-LAE-DAT-30MIN`
- Added new filetype `PROC-ETH-METEOSCREENINGTOOL-CH-LAE-CSV-30MIN`
- Added new filetype `PROC-ETH-METEOSCREENINGTOOL-CH-AWS-CSV-30MIN`
- Fixed naming in LAE filetypes
